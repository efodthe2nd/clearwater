const payments = [
  {
    ...
    description:
      'All payments run through Escrow.com, which holds the funds safely and releases them only when both sides confirm everything is good.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    ...
    description:
      'Once we agree on terms, we wire the full payment to escrow before you hand over access to your site. You’ll always know the money is locked in.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    ...
    description:
      'You transfer the site only after escrow confirms the funds are secured. After that, payment is released to you, usually within hours.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    ...
    description:
      'We cover all escrow fees. The amount you see is the amount you get.',
  },
]
