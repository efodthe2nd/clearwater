const features = [
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <path d="M12 3L4 7v5c0 4.418 3.582 8.618 8 9.9C16.418 20.618 20 16.418 20 12V7L12 3z" fill="#F7F217"/>
  ...
  },
  {
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
        <path d="M12 3C12 3 6 10 6 14.5a6 6 0 0012 0C18 10 12 3 12 3z" fill="#F7F217"/>
      </svg>
    ),
    title: 'Safe & Simple:',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="font-black leading-tight">
            <span className="text-[#F7F217] text-4xl md:text-6xl block">We Buy Sites</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <span className="text-[#F7F217] font-black leading-none" style={{ fontSize: 'clamp(5rem, 12vw, 7rem)' }}>
              20
            </span>
            <p className="text-white font-semibold text-base mt-2">Days Maximum</p>
            <p className="text-white/60 text-sm mt-1">
              We Close Most Deals{' '}
              <span className="text-[#F7F217] font-semibold">in 7 to 10 Days</span>
            </p>
          </div>
        </div>
